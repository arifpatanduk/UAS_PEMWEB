...
<Head>
    ...
    <title>Edit Anggota | INIPerpus</title>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($dataanggota)) : ?>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 label-column">
                                    <label class="control-label" for="name-input-field">Kode Anggota</label>
                                </div>
                                <div class="col-sm-6 input-column">
                                    <input type="text" class="form-control" name="kode" placeholder="Masukkan Nama" value="<?= $row['id_anggota']; ?>" required disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-4 label-column">
                                ...
                                <div class="col-sm-6 input-column">
                                    <input type="text" class="form-control" name="nama" value="<?= $row['nama_anggota']; ?>" placeholder="Masukkan Nama" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-4 label-column">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 input-column">
                                    <input type="text" class="form-control" name="pekerjaan" value="<?= $row['pekerjaan_anggota']; ?>" placeholder="Masukkan pekerjaan" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-4 label-column">
                                ...
                                <div class="col-sm-6 input-column">
                                    <input type="text" class="form-control" name="nomortelp" value="<?= $row['no_telp_anggota']; ?>" placeholder="Masukkan Nomor Telepon" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-4 label-column">
                                ...
                                <div class="col-sm-6 input-column">
                                    <input type="text" class="form-control" name="alamat" value="<?= $row['alamat_anggota']; ?>" placeholder="Masukkan Alamat" required>
                                </div>
                            </div>
                        <?php endwhile; ?>
                        <button class="btn btn-default submit-button" type="submit" name="submit" id="yes">Update Anggota</button>
                    </form>
                </div>
            </div>
