                    ...
                    <form class="form-horizontal custom-form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-column">
                                <input type="text" class="form-control" name="kode" placeholder="Masukkan Kode Buku" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4 label-column">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-column">
                                <input type="text" class="form-control" name="penulis" placeholder="Masukkan Penulis" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4 label-column">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-column">
                                <input type="text" class="form-control" name="nama_rak" placeholder="Masukkan Nama Rak" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4 label-column">
                            ...
                            <div class="col-sm-6 input-column">
                                <input type="text" class="form-control" name="lokasi" placeholder="Masukkan Lokasi Rak" required>
                            </div>
                        </div>
                        <button class="btn btn-default submit-button" type="submit" name="submit" id="yes">Tambah Buku</button>
                    </form>
                </div>
            </div>
