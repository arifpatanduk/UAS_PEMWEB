...
if (isset($_POST['submit'])) {
    if (tambah($_POST) > 0) {
        echo "
        <script>alert('Tambah Petugas berhasil');
...
<Head>
    ...
    <title>Tambah Petugas | INIPerpus</title>
            ...
            <div class="content">
                <div class="row register-form" style="margin-top:-50px;">
                    <form class="form-horizontal custom-form" action="" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 label-column">
                                <label class="control-label" for="name-input-field">Konfirmasi Password</label>
                            </div>
                            <div class="col-sm-6 input-column">
                                <input type="password" class="form-control" name="konfirmasi" placeholder="Ulangi Password" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4 label-column">
